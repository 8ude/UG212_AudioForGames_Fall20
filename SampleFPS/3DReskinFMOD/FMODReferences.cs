...
public class FMODReferences : ScriptableObject
{
	...
	[FMODUnity.EventRef]
	public string LoseGame = "event:/UISounds/LoseGame";
	...
	[FMODUnity.EventRef]
	public string ShootShotgun = "event:/PlayerCombat/ShootShotgun";

	[FMODUnity.EventRef]
	public string ReloadShotgun = "event:/PlayerCombat/ReloadShotgun";
	...
	[FMODUnity.EventRef]
	public string PickupShotgun = "event:/PlayerPowerups/PickupShotgun";
