...
public class WeaponController : MonoBehaviour
{
    ...
    //new FMOD
    [FMODUnity.EventRef] public string shootEventString;

    [Tooltip("Sound played when changing to this weapon")]
    //public AudioClip changeWeaponSFX;

    //new FMOD
    [FMODUnity.EventRef] public string changeWeaponString;
    ...
    [FMODUnity.EventRef] public string continuousShootEventRef;

    FMODUnity.StudioEventEmitter continuousShootEmitter = null;
    ...
    void Awake()
    {
        ...
        if (useContinuousShootSound)
        {
            ...
            //new fmod
            continuousShootEmitter = gameObject.AddComponent<FMODUnity.StudioEventEmitter>();

            continuousShootEmitter.Event = continuousShootEventRef;
        }
    }
    ...
    private void UpdateContinuousShootSound()
    {
        if (useContinuousShootSound)
        {
            ...
            {
                if(!continuousShootEmitter.IsPlaying())
                {
                    continuousShootEmitter.Play();
                }
            ...
            else if (continuousShootEmitter.IsPlaying())
            {
                 continuousShootEmitter.Stop();
            }
        }
    }
    ...
    public void ShowWeapon(bool show)
    {
        ...
        if (show && changeWeaponString != null)
        {
            FMODUnity.RuntimeManager.PlayOneShot(changeWeaponString);
        }
