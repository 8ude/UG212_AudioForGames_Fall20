...
public class Jetpack : MonoBehaviour
{
    ...
    //fmod todo - add parameters, including jetpack fill amount
    [Header("Audio")]
    ...
    void Start()
    {
        ...
        //no need to initialize on start
        //audioSource.clip = jetpackSFX;
        //audioSource.loop = true;

        audioEmitter.Event = ReskinGameAudio.instance.audioRefs.UseJetpack;
    }
    ...
    void Update()
    {
        ...
        if(jetpackIsInUse)
        {
            ...
            audioEmitter.SetParameter("JetpackFuel", currentFillRatio);
        }
        else
        {
