...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    //fmod todo - attaching one shots? sustains?
    ...
    void Update()
    {
        ...
        if (isGrounded && !wasGrounded)
        {
            ...
            if (recievesFallDamage && fallSpeedRatio > 0f)
            {
                ...
                FMODUnity.RuntimeManager.PlayOneShot(ReskinGameAudio.instance.audioRefs.FallDamage);
            }
            else
            {
                // land SFX
                ...
                FMODUnity.RuntimeManager.PlayOneShot(ReskinGameAudio.instance.audioRefs.Land);
            }
        }
    ...
    void OnDie()
    {
        ...
        FMODUnity.RuntimeManager.PlayOneShot(ReskinGameAudio.instance.audioRefs.PlayerLose);
    }
            ...
            if (isGrounded)
            {
                ...
                if (isGrounded && m_InputHandler.GetJumpInputDown())
                {
                    ...
                    if (SetCrouchingState(false, false))
                    {
                        ...
                        FMODUnity.RuntimeManager.PlayOneShot(ReskinGameAudio.instance.audioRefs.Jump);
                ...
                if (m_footstepDistanceCounter >= 1f / chosenFootstepSFXFrequency)
                {
                    ...
                    FMODUnity.RuntimeManager.PlayOneShot(ReskinGameAudio.instance.audioRefs.Footstep);
                }
